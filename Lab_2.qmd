...
Partition the data into 10 random sets (tests and training) with equal numbers of data points in them
What metric?
  Root mean squared error
  Make a function for RMSE
For loop
  Apply the model to each of the training folds
...
#I think it replaces the sampled number back into the sample set before it redraws the next one
...
sample(ex,size=100,replace=TRUE)
